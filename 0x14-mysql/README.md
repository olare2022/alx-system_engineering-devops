...
This project is about learning how to configure database servers in a
primary-replica model. I was able to configure the two servers provided to me by
Best School in a MySQL primary-replica setup with a dummy database,
